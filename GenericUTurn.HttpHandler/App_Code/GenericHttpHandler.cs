...
public class GenericHttpHandler : IHttpHandler
{
    ...
    protected virtual XmlDocument ProcessXml(string url, string action, XmlDocument document)
    {
        // debug info:
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        if(request.Headers["SOAPAction"] != null)
        {
            ...
            var result  = ProcessXml(request.RawUrl, request.Headers["SOAPAction"], soapenvelop);
